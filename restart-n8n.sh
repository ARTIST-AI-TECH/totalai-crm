...
docker run -d \
  ...
  -e N8N_WEBHOOK_SECRET=dev-secret-change-in-production \
  n8n-puppeteer

echo "n8n container restarted with CRM webhook configuration"
echo "CRM_WEBHOOK_URL: https://flowpro-totalai.netlify.app"
echo "N8N_WEBHOOK_SECRET: dev-secret-change-in-production"
